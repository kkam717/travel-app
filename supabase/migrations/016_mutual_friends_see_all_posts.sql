-- Mutual friends (both follow each other) can see ALL posts from each other: public, friends, AND private
-- This applies everywhere: feed, search, author profile, etc.

-- 1. Update RLS: private also visible to mutual friends
...
-- 2. Update itinerary_stops to match
...
-- 3. Update search_itineraries: include private from mutual friends
